...
class SIMPLE_COVERPAGEPDF extends MBFPDF
{
	...
	function coverpage($_param, $_county,$_form){
		...
		if($_param['Company']['SEAL']){
			$this->Image($_param['Company']['SEAL_IMAGE'],100, 25, 50,15);
		}
	...
	function writeCompanyInfo($_param, $_county, $_x, $_y){
	    ...
	    $str = $_param['Company']['REPRESENTATIVE'];
	    $str = $this->conv($str);
	    $this->Write(5, $str);
